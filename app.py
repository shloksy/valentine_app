...
if st.session_state.stage == "ask":
    ...
    with col2:
        if not hide_no:
            ...
            st.markdown('<div class="msg">Okay... I will take that as a Yes :)</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="val-sub">(I knew you would say yes 😎)</div>', unsafe_allow_html=True)
